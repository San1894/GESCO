	...
	await fetch("get.php", {
		...
		.then((result) => {
            ...
            <tr data-id=${contact.id}>
               ...
               <td>
                  <button type="button"  id="edit-contact" class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#completeModal">Modifier</button>
                  <button type="button" id="delete-contact" class="btn btn-outline-danger">Supprimer</button>
               </td>
            </tr>
        `;
				})
